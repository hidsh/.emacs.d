...
(def-doom-theme my-doom-material
  ...
  ((bg         '("#212B31" nil       nil))
   ...
   ;; (dark-teal2     '("#408C83" "dark cyan" "dark cyan"))
   ;; (dark-teal      '("#3A928B" "dark cyan" "dark cyan"))
   (dark-teal3     '("#4C6B6B" "dark cyan" "dark cyan"))
   ;; (dark-teal2     '("#557777" "dark cyan" "dark cyan"))
   (dark-teal2     '("#658D8E" "dark cyan" "dark cyan"))
   ;; (dark-teal2     '("#528b8b" "dark cyan" "dark cyan"))
   ;; (dark-teal2     '("#2F756F" "dark cyan" "dark cyan"))
...
;; (fringe :background base2)
   ...
   (consult-preview-insertion :foreground fg :background dark-teal3)
