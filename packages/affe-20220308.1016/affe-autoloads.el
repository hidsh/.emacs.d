;;; affe-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "affe" '("affe-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "affe-backend" '("affe-backend--")))
