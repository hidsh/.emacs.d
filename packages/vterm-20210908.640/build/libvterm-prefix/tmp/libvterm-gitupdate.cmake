...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "54c03b21f763fa775a4c0643a9d8326342873179"
  WORKING_DIRECTORY "/Users/g/.emacs.d/packages/vterm-20210908.640/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/g/.emacs.d/packages/vterm-20210908.640/build/libvterm-prefix/src/libvterm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/g/.emacs.d/packages/vterm-20210908.640/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
